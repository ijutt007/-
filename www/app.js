...
// ---------------------------------------------------------------------------
// Path to the authentic King Fahd Complex 15-line Mushaf PDF inside assets/
const QURAN_PDF_PATH = "assets/Quran-e-Majeed-Majma-Malik-Fahad.pdf";
...
if (iframe) {
iframe.src = QURAN_PDF_PATH + "#page=" + physicalPage + "&view=FitH";
}
...
B) VALIDATION REPORT
Updated Quran PDF path exact match (assets/Quran-e-Majeed-Majma-Malik-Fahad.pdf): YES
const QURAN_PDF_PAGE_OFFSET = 0; preserved: YES
Quran PDF offset claimed verified: NO (Explicitly documented as unverified pending check against the actual supplied PDF)
All features preserved (Tasbeeh, targets, vibration, Adhkar, incomplete Manzil notice, navigation, bookmarks, prayer engine, city picker, fonts, localStorage): YES
Syntax valid with no duplicate declarations or truncated code: YES
